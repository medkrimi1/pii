...
@Component({
  selector: 'app-organisateur-event-edit',
  templateUrl: './organisateur-event-edit.component.html',
  styleUrls: ['./organisateur-event-edit.component.scss']
})
export class OrganisateurEventEditComponent implements OnInit {
